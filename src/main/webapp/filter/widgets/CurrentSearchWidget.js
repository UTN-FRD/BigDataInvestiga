...
AjaxSolr.CurrentSearchWidget = AjaxSolr.AbstractWidget.extend({
  ...
  afterRequest: function () {
    ...
    $('#download-results').attr('href', this.manager.solrUrl+'select?rows=1000&'+this.manager.store.string()+'&fl=Fecha_Origen,Nro_Origen,Nro_Destino,Tipo_Comunicacion,Duracion,Celda_Origen&wt=csv');
